...
| `min_genes`           | Minimum number of genes required for a cell to be considered. Defaults to `1`. If set to `0`, no filtering is performed. This can lead to problems with some downstream tools and is discouraged.                                                                                                                                                                                                                    |
| `min_cells`           | Minimum number of cells required for a gene to be considered. Defaults to `1`. If set to `0`, no filtering is performed. This can lead to problems with some downstream tools and is discouraged.                                                                                                                                                                                                                    |
| `min_counts_cell`     | Minimum number of counts required for a cell to be considered. Defaults to `1`. If set to `0`, no filtering is performed. This can lead to problems with some downstream tools and is discouraged.                                                                                                                                                                                                                   |
| `min_counts_gene`     | Minimum number of counts required for a gene to be considered. Defaults to `1`. If set to `0`, no filtering is performed. This can lead to problems with some downstream tools and is discouraged.                                                                                                                                                                                                                   |
